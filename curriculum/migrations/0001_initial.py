    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signature', models.ImageField(blank=True, default='school_logo.jpg', help_text='must not exceed 180px by 180px in size', null=True, upload_to='official_pics')),
                ('slug', models.SlugField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promotion_order', models.IntegerField(help_text='Order of classes for promotion (e.g., 1 for Basic 1, 2 for Basic 2)', unique=True)),
                ('slug', models.SlugField(blank=True, null=True)),
            ],
            options={
